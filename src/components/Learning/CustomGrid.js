    ...
    return (
      <View style={styles.container}>
        <View style={styles.gridContainerHorizontal}>
          <View style={styles.horizontaLineBorder}></View>
          <View style={styles.horizontaLineNoBorder}></View>
          <View style={styles.horizontaLineBorder}></View>
          <View style={styles.horizontaLineNoBorder}></View>
          <View style={styles.horizontaLineBorder}></View>
          <View style={styles.horizontaLineNoBorder}></View>
        ...
        <View style={styles.gridContainerVertical}>
          <View style={styles.verticalLineBorder}></View>
          <View style={styles.verticalLineNoBorder}></View>
          <View style={styles.verticalLineBorder}></View>
          <View style={styles.verticalLineNoBorder}></View>
          <View style={styles.verticalLineBorder}></View>
          <View style={styles.verticalLineNoBorder}></View>
